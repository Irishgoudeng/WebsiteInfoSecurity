    ...
    <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
      ...
      <div class="w-full h-100">
        ...
        <form class="mt-6" action="#" method="post">
          ...
          <a href="home.html"><button type="submit" name= "submit"class="w-full block bg-black hover:bg-gray-500 focus:bg-gray-400  text-white font-semibold rounded-lg
                px-4 py-3 mt-6">Log In</button></a>
        </form>
  
        <hr class="my-6 border-gray-300 w-full">
  
        <a href="home.html"><button type="button" class="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
